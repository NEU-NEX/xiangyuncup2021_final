    ...
    return QueryableDropdownSelect.extend({
        ...
        updateAriaLabel: function updateAriaLabel() {
            ...
            var updateLabel = function () {
                ...
                // without the punctuations screen reader reads the whole thing in one single breath.
                this.$field.attr("aria-label", selectedValues.length > 0 ? [labelText, "- ", selectedValues.join(", "), "."].join("") : null);
            }.bind(this);
